...
AH Milans (also written **Ahmilan's Gallery**) is a curatorial label based in **Paris, France**, dedicated to emerging contemporary art. It is not a gallery in the traditional sense — it operates as a filter, a curatorial voice, and an editorial platform committed to artists whose practice deserves sustained attention.
...
| Artists | `/artistes` | Full roster — all represented artists |
| Artist page | `/artistes/[slug]` | Artist profile: biography, featured image, full list of works |
| Works | `/oeuvres` | All available artworks, filterable by artist |
| Artwork page | `/oeuvres/[slug]` | Full artwork detail: images, medium, dimensions, year, price, acquisition inquiry |
| Journal | `/articles` | Editorial content: interviews, essays, artist portraits |
| Article page | `/articles/[slug]` | Full article with body, category, read time |
